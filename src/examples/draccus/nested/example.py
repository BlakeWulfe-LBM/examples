...
@dataclass
class LogConfig(draccus.ChoiceRegistry):
    """ Base config for logging arguments """
    pass


@LogConfig.register_subclass("ExpLogConfig")
@dataclass
class ExpLogConfig(LogConfig):
    """ Config for experiment logging arguments """
    # The experiment name
...
@dataclass
class TrainConfig:
    log: LogConfig = field(default_factory=ExpLogConfig)
